...
public class IIPResponse {
  public static record SIngleInstance(String baseyear, int year, String month, String state, String sector, String category, String sub_category, String index, String inflation, String status) {
